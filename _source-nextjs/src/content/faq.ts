...
export const faq: FaqItem[] = [
  {
    ...
    answer: [
      "Nous partons de votre situation pour comprendre ce qui se joue et mettre en place des outils concrets, adaptés à votre fonctionnement.",      "Une séance dure 1 heure. Vous repartez avec un travail à expérimenter, et nous faisons le point lors d’un rendez-vous de suivi, par téléphone ou en visio, avant la séance suivante.",
    ],
  },
  {
